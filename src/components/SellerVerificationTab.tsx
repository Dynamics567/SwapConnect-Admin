...
// Relocated from the standalone /dashboard/seller-verification page (now a
// redirect) into a tab of User Management -- Seller Verification's
// approve/reject/tier flow operates on the exact same userId records that
// page already manages. Behavior, copy, and API calls are unchanged from the
// original page; only the outer page-layout wrapper was dropped since the
// parent page (dashboard/user) already provides it.
export default function SellerVerificationTab() {
